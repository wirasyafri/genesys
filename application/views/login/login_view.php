...
<body style="background-image: url(<?php echo base_url()."images/dark_souls_ii_dark_souls_warrior_knight_from_software_namco_bandai_games_98197_1920x1080.jpg"?>); ">
<?php echo form_open('login/cekLogin'); ?>
	<div class="padding-all">
		<div class="header">
			<h1><img src="<?=base_url()?>/images/5.png" alt=" "> Genesys Login Form</h1>
		</div>
