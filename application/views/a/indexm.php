...
<header class="header" id="header" style="background-image: url(<?php echo base_url()."images/pw_maze_black_2X.png"?>); "><!--header-start-->
	<div class="container" >
        ...
        <ul class="we-create animated fadeInUp delay-1s">
        	<li>SELAMAT DATANG DI WEBSITE GAMING INDONESIA</li>
        </ul>
            <a class="link animated fadeInUp delay-1s" href="#test">YUK MAIN</a>
    </div>
</header><!--header-end-->
...
<nav class="main-nav-outer" id="test" ><!--main-nav-start-->
	<div class="container">
        <ul class="main-nav">
            ...
            <li><a href="<?php echo site_url();?>/pegawai/toko"><i class="glyphicon glyphicon-shopping-cart"></i>Toko</a></li>
...
<section class="main-section" id="service" style="background-image: url(<?php echo base_url()."images/dark_souls_ii_dark_souls_warrior_knight_from_software_namco_bandai_games_98197_1920x1080.jpg"?>); "><!--main-section-start-->
	<div class="container">
    	<?php $this->load->view('pegawai/tampil_pegawai_view'); ?>
	</div>
