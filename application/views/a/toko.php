...
<section class="main-section paddind" id="toko" style="background-image: url(<?php echo base_url()."images/dark_souls_ii_dark_souls_warrior_knight_from_software_namco_bandai_games_98197_1920x1080.jpg"?>); "><!--main-section-start-->
	<div class="container">
    	
        <?php $this->load->view('pegawai/tampil_toko'); ?>
	</div>
