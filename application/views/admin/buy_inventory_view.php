...
<div class="row">
	...
	<?php echo form_open_multipart('admin/Buyproses/'.$this->uri->segment(3));?>
	<legend>Beli Barang</legend>
<?php 
//var_dump($barang);
?>
	<?php 
	...
	<div class="form-group">
		...
		<input type="text" name="beli" class="form-control" id="beli" placeholder="jumlah beli">
		<?php //echo validation_errors();  ?>						
	</div>
